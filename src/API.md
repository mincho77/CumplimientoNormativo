...
### `POST /api/analizar`
**Analizar norma con IA (JSON estructurado)**

Acepta una URL de PDF o un PDF en upload y retorna extracción estructurada.

#### Request A: JSON
```json
{
  "url": "https://entidad.gov.co/norma.pdf"
}
```
...
- `_repair_info` indica si hubo auto-reparación y cuántos intentos se realizaron.
- Si no se puede recuperar una salida válida, se devuelve un fallback JSON consistente.

---

### `GET /api/repair_metrics`
**Métricas históricas de auto-reparación**

Calcula KPIs desde `data/state/ia_repair_history.jsonl`.
...
```json
{
  ...
  "metrics": {
    "total_runs": 42,
    "initial_invalid_rate": 19.05,
    "recovery_rate": 75.0,
    "fallback_rate_total": 4.76,
    "fallback_rate_invalid": 25.0,
    "avg_repair_attempts_invalid": 1.25,
    "top_repair_reasons": [
      { "reason": "json inválido", "count": 3 }
    ],
    "last_event_at": "2026-07-06T17:30:00+00:00"
  }
}
```
